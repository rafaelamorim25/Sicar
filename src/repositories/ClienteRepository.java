...
public class ClienteRepository {
	...
	public Cliente findBy(Integer id) {
		...
		try {
			...
			while (resultSet.next()) {
				cliente = new Cliente(resultSet.getInt(1), resultSet.getString(2), resultSet.getLong(3),
	...
	public List<Cliente> findAll() {
		...
		try {
			...
			while (resultSet.next()) {
				Cliente cliente = new Cliente(resultSet.getInt(1), resultSet.getString(2), resultSet.getLong(3),
						resultSet.getString(4));
				lancamentoRepository.findLancamentosFrom(cliente);
	...
	public List<Cliente> customSearch(String keyword) {
		String sql = "SELECT id_cliente, nome_cliente, cpf_cliente, email_cliente FROM cliente WHERE"
				+ " nome_cliente LIKE '%" + keyword + "%' OR email_cliente LIKE '%" + keyword + "%'";
		List<Cliente> clientes = new ArrayList<Cliente>();
